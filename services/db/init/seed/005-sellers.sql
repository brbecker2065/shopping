insert into sellers (seller_handle, username, first_name, middle_name, last_name, suffix, email, joined_date) values
    ...
    ('12469d45-1a73-41ad-ba62-7bbd4be3278f', 'NPC 1', 'John', 'Z', 'Doe', '', 'npc1@gmail.com', now()),
